...
#==============================================================================
# IAM User 정보 (로컬 개발용 - 백엔드 개발자에게 전달)
#==============================================================================
output "iam_user_access_key_id" {
  description = "Access Key ID (로컬 개발용)"
  value       = module.s3_images.iam_user_access_key_id
}

output "iam_user_secret_access_key" {
  description = "Secret Access Key (로컬 개발용) - terraform output -raw iam_user_secret_access_key 로 확인"
