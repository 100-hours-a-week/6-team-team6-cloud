# v2/envs/prod/outputs.tf
# Billage v2 Prod 환경 출력값
...
# Private Subnet IDs (RDS용)는 shared/rds/prod에서 관리
...
#==============================================================================
# RDS (shared/rds/prod에서 참조 - v2 전용 RDS)
#==============================================================================
output "rds_endpoint" {
...
output "app_url" {
  ...
  value       = "https://v2.${var.domain_name}"
}
